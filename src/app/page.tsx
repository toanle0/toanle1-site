    ...
    <main className="min-h-screen bg-[#0b1220] px-6 py-10 text-white">
      <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-[320px_1fr]">
        ...
        <aside className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-xl">
          ...
          <h2 className="mt-6 text-center text-2xl font-bold">Toan Le</h2>
          ...
          <div className="mt-8">
            ...
            <div className="space-y-3 text-sm text-gray-300">
              <p>Location: California</p>
              <p>Email: toanle1@protonmail.com</p>
              <p>GitHub: github.com/toanle0</p>
              <p>LinkedIn: linkedin.com/in/toan-le-561204366</p>
            </div>
          </div>
        ...
        <section className="rounded-2xl border border-white/10 bg-black/30 p-8 shadow-xl">
          ...
          <header className="border-b border-white/10 pb-6">
            ...
            <p className="mt-4 text-xl text-gray-300">
              Computer Science graduate building web apps,
              cybersecurity labs, and practical technical tools.
            </p>
          </header>
          ...
          <section className="mt-10">
            ...
            <p className="mt-4 max-w-3xl text-gray-300">
              I am a Computer Science graduate from CSULB with strong
              interests in software engineering, cybersecurity, and
              building useful software projects. My work focuses on
              practical systems including web applications, browser
              extensions, and technical tools.
            </p>
          </section>
          ...
          <section className="mt-10">
            ...
            <div className="mt-6 space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Networking • Python • Security tools
                </p>
              </div>
